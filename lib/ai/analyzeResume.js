...
IMPORTANT: "strengths" and "missing_skills" MUST be JSON arrays of quoted strings. "suggestions" MUST be a single quoted string. Do NOT write them as plain paragraphs or unquoted text.
