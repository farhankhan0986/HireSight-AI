    ...
    <main className="bg-background text-foreground overflow-hidden relative -top-10">
        ...
        <div className="mx-auto max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-left order-2 lg:order-1">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="inline-flex items-center gap-2 mb-6 rounded-md border border-border bg-foreground/5 px-3 py-1.5"
            >
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tighter mb-6 text-foreground"
            >
              Hire with clarity.
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-base md:text-lg text-foreground/70 leading-relaxed max-w-xl mb-8 font-medium"
            >
              HireSight-AI helps teams verify talent, analyze skills, and make faster hiring
              decisions using real-time intelligence — eliminating bias and guesswork.
            </motion.p>
            ...
            >
              <Link
                ...
                className="group relative px-6 py-3 rounded-md bg-foreground text-background text-sm font-bold transition-all hover:bg-foreground/90 shadow-sm"
              >
                Start Hiring
              </Link>
              ...
              <Link
                href="/jobs"
                className="group px-6 py-3 rounded-md border border-border bg-background text-foreground text-sm font-bold hover:bg-foreground/5 transition-all shadow-sm"
              >
                Explore Jobs
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="flex flex-wrap items-center gap-6 text-xs text-foreground/60 font-medium"
            >
          ...
          {/* RIGHT VISUAL – MINIMALIST DASHBOARD */}
          <motion.div
            variants={fadeUp}
            custom={3}
            initial="hidden"
            ...
            <div className="relative rounded-xl border border-primary/20 bg-card/80 backdrop-blur-xl shadow-lg shadow-primary/5 p-6 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-border">
                  ...
                  <span className="flex items-center gap-1.5 px-2.5 py-1 text-[10px] rounded-md bg-foreground text-background font-bold tracking-wide">
                    Live View
                  </span>
                </div>

                {/* Candidate List (Minimal Table-like structure) */}
                <div className="space-y-0">
                  <div className="grid grid-cols-12 gap-4 pb-2 text-[10px] font-bold text-foreground/50 uppercase tracking-wider">
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      className="grid grid-cols-12 gap-4 items-center py-3 border-t border-border/50 group hover:bg-foreground/5 transition-colors -mx-6 px-6"
                    >
                      <div className="col-span-6 flex items-center gap-3">
                        <div className={`w-8 h-8 rounded-md bg-gradient-to-br ${c.color} flex items-center justify-center ${c.textColor} font-bold text-xs ring-1 ring-inset ring-current/20`}>
                ...
                {/* AI Insight Box (Clean) */}
                <div className="mt-6 rounded-xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-4 border border-primary/20 shadow-inner">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-foreground/80 leading-relaxed font-medium">
                        Top candidates currently exhibit an <span className="text-primary font-bold">85%+ alignment</span> with required technical competencies.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="relative py-20 px-6 mx-auto max-w-7xl mb-20 overflow-hidden mt-24">
        ...
        <div className="relative text-center">
          ...
          >
            <Link href="/analyzer" className="group relative px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-primary/90 text-primary-foreground text-sm font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-300 overflow-hidden hover:scale-105">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
            {[
              ...
              <motion.div
                ...
                className="group relative bg-card/60 backdrop-blur-md border border-border/60 hover:border-primary/50 hover:shadow-[0_0_30px_-5px_var(--primary)] hover:shadow-primary/20 rounded-2xl p-5 transition-all duration-300 overflow-hidden cursor-pointer"
              >
                {/* Animated gradient background */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${skill.color} opacity-5 group-hover:opacity-20 transition-opacity duration-500`}
                />
                ...
                <div className="relative z-10">
                  ...
                  <div className="relative h-1 bg-foreground/5 rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      whileInView={{
                        width: skill.demand === "Critical" ? "95%" : skill.demand === "Very High" ? "85%" : "70%",
                      }}
                      viewport={{ once: true }}
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs md:text-sm">
                Based on <strong className="text-foreground">global tech market analysis</strong>
              </span>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                variants={fadeUp}
                whileHover={{ y: -6, scale: 1.02 }}
                className="group relative bg-card/60 backdrop-blur-md border border-border/60 hover:border-primary/50 hover:shadow-[0_0_30px_-5px_var(--primary)] hover:shadow-primary/20 rounded-2xl p-6 transition-all duration-300 overflow-hidden cursor-pointer"
              >
                {/* Hover gradient background */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-5 group-hover:opacity-20 transition-opacity duration-500" />
                ...
                {/* Glow effect */}
                <div className="absolute -inset-1 rounded-2xl bg-primary/20 opacity-0 blur-xl group-hover:opacity-100 transition-opacity duration-300 z-0" />
